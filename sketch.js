...
ground=createSprite(300,700,80,80) 
  ...
  invisibleground= createSprite(500,700,displayWidth,10)
  invisibleground.visible=false;
  
  trex=createSprite(100,680,50,50)
trex.addAnimation("run", trexrun)
trex.scale=0.8;
  
gameOver2=createSprite(500,500,100,100);
...
function obstacles() {
  if(frameCount%80===0){
    obstacle=createSprite(1000,680,50,50);
